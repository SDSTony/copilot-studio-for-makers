...
- New Experience UI는 최근 출시된 첫 세대 제품으로, 다른 모든 초기 제품과 마찬가지로 자잘한 버그들이 존재할 수 있습니다. 버그로 인해 실습이 원활하게 진행되지 않는다면, 새로운 개념을 학습하는 과정에서 불필요한 혼란이 생길 수 있습니다.
- Classic UI에 대한 지원 종료가 발표난 것은 없으며, 현재는 두 UI가 계속 병행 제공될 예정입니다.
