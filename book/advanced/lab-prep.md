...
[📥 실습 파일 다운로드](https://github.com/SDSTony/copilot-studio-for-makers/raw/main/lab%20files/lab%20files.zip)
```
...
4. 아래와 같이 필요한 정보들을 채워넣는다. 그리고 다음을 클릭한다.
   - 이름: Dev-Edu-사번뒤4자리 (예: 사번이 7891111 인 경우 -> Dev-Edu-1111)
   - 지역: 대한민국 (대한민국에 있는 데이터 센터가 물리적으로 더 가까울 수 있고, 그에 따라 반응 속도가 조금은 빨라질 수 있다)
   - 유형: 개발자
